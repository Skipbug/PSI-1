...
\usepackage{geometry}
\geometry{verbose,letterpaper,tmargin=2cm,bmargin=2cm,lmargin=3cm,rmargin=1.5cm}
...
%\renewcommand{\includegraphics}[1]{\Oldincludegraphics[width=0.75\maxwidth]{#1}}
$endif$
...
\title{	\vskip 20pt
        ...
        \bigskip
        \centerline{\large {PROGRAMŲ SISTEMŲ KATEDRA}}
        \vskip 120pt
        \begin{center}
        {\bf \LARGE Automatinis aktualaus RSS turinio atrinkimas}
        \end{center}
        \bigskip
        \centerline{\Large \textbf{I Laboratorinis darbas - verslo tikslų ir poreikių specifikacija}}
        \vskip 120pt
        \begin{large}
        \begin{tabbing}
        {\hskip 5cm}
