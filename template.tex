...
\title{	\normalsize \textsc{I Laboratorinis darbas} 	% Subtitle of the document
		 	\\[2.0cm]													% 2cm spacing
			\HRule{0.5pt} \\										% Upper rule
			\LARGE \textbf{\uppercase{Automatinis aktualaus RSS turinio atrinkimas}}	% Title
			\HRule{2pt} \\ [0.5cm]								% Lower rule + 0.5cm spacing
            \normalsize{2012 Rugsėjis} %\today									% Todays date
		}
